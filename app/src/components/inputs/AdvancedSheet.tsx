...
import type { HomeOwnerCount, LoanRepaymentType, JeonseInsuranceProvider } from '@/types';
  ...
  return (
    <>
      <button
        ...
        className="w-full flex items-center justify-between px-4 py-3 bg-gray-50 rounded-xl text-sm text-gray-600 font-medium active:bg-gray-100 transition-colors"
      >
        <span>⚙️ 상세 설정</span>
          ...
          >
            ...
            >
              ...
              <div className="px-5 pt-5 space-y-8">
                ...
                {/* 월세 상세 */}
                <section className="space-y-5">
                  <h3 className="text-sm font-bold text-emerald-500 uppercase tracking-wide">
                    월세 상세
                  </h3>
